...
const HemiLogoImpl = function () {
  ...
  const href = featureFlags.enableHemiEarnPage ? '/hemi-earn' : tunnelHref

  return <UI href={href} />
}

export const HomeLink = () => (
  // The logo link redirects based on feature flag. When the Hemi Earn page is enabled, it goes to
  // /hemi-earn. Otherwise, it redirects to the tunnel page with the appropriate operation
  ...
  <Suspense
    fallback={
      <UI href={featureFlags.enableHemiEarnPage ? '/hemi-earn' : '/tunnel'} />
    }
  >
    <HemiLogoImpl />
  </Suspense>
