// TODO add logic with rainbow kit here
// as this can only be interacted in the FE, we should
// load it with next/dynamic
export const AddNetworkToWallet = () => (
  <button className="cursor-pointer rounded-xl bg-white px-3 py-2">
