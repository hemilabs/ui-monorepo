...
export const hemiPublicExtraActions = () => client => ({
  ...
  // once there's a determined way to get the "most adequate" custodial and
  // support multiple types of vaults.
  // See https://github.com/hemilabs/ui-monorepo/issues/393
  getVaultChildIndex: () => Promise.resolve(1), // TODO move this to an env var
})
