...
export const ToggleNetwork = ({ disabled, toggle }: Props) => (
  <button
    className={`shadow-soft mx-auto h-8 w-8 rounded-lg border border-solid border-neutral-300/55 bg-white p-2 text-neutral-500 hover:bg-neutral-100 hover:text-neutral-950 ${
