export const DatabaseIcon = () => (
  <svg fill="none" height={16} width={16} xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M8 8.5c1.84 0 3.579-.37 4.914-1.037.384-.19.748-.42 1.086-.683V8c0 1.657-2.686 3-6 3S2 9.657 2 8V6.78c.346.273.72.5 1.087.683C4.42 8.131 6.16 8.5 8 8.5Z"
      fill="#A3A3A3"
    />
    <path
