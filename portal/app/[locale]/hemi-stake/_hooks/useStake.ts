  ...
  return useMutation({
    mutationFn: async function runCreateLock() {
      ...
      emitter.on('approve-transaction-reverted', function (receipt) {
        ...
        track?.('hemi stake - approve reverted')
      })
      emitter.on('user-signing-approve-error', function () {
        ...
        track?.('hemi stake - signing approve error')
      })
      emitter.on('approve-failed', function () {
        ...
        track?.('hemi stake - approve failed')
      })
      ...
      emitter.on('user-signed-lock-creation', function (transactionHash) {
        ...
        track?.('hemi stake - signed lock creation')
      })
      emitter.on('user-signing-lock-creation-error', function () {
        ...
        track?.('hemi stake - signing lock creation error')
      })
      emitter.on('lock-creation-failed-validation', function () {
        ...
        track?.('hemi stake - lock creation failed validation')
      })
      emitter.on('lock-creation-failed', function () {
        ...
        track?.('hemi stake - lock creation failed')
      })
      emitter.on('lock-creation-transaction-succeeded', function (receipt) {
        ...
        track?.('hemi stake - lock creation success')
      })
      emitter.on('lock-creation-transaction-reverted', function (receipt) {
        ...
        track?.('hemi stake - lock creation reverted')
      })
